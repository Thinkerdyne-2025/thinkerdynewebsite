          ...
          <address className="footer__address">
            <p className="footer__line">
              ...
              <span>
                ...
                <br></br>
                NO: 59,60, NL ARCADE, SECOND MAIN, VINAYAKA LAYOUT, <br />{" "}
                SHANTHIPURA ELECTRONIC CITY, PHASE II, BANGALORE, <br />{" "}
                KARNATAKA. 560100
              </span>
            </p>
            <div className="footer__contact-row">
              <p className="footer__line footer__line--inline email-phone">
                <span
            ...
            <p className="footer__iso">ISO 9001:2015 Certified</p>
          </address>
        </div>
        <div className="footer__col footer__core-services">
          <h3 className="footer__heading_service core_services">
            Core Services
          </h3>
